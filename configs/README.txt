...
The examples are generally focused on a particular use case (e.g., support for a restricted number of ciphersuites) and aim to minimize resource usage for this target. They can be used as a basis for custom configurations.
